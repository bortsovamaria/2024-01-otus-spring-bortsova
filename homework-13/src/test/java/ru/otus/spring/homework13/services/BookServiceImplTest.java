...
import ru.otus.spring.homework13.repositories.BookRepository;
import ru.otus.spring.homework13.repositories.GenreRepository;
import ru.otus.spring.homework13.utils.BookUtils;
...
class BookServiceImplTest {
    ...
    void shouldCorrectFindAllBooks() {
        given(bookRepository.findAll()).willReturn(BookUtils.getExpectedBooks());
        bookService.findAll();
